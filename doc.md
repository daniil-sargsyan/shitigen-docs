...
```json
{
    "FIELDS": {
        ...
        "UF_CRM_1727879297283": "Y",
        "UF_CRM_1736350790973": "Установка системы GUID",
        "UF_CRM_1727772090639": 1,
        "UF_CRM_1727772136792": 1,
        "UF_CRM_1727715543786": {
            "fileData": [
                "test2.txt",
                "AA=="
            ]
        },
        "UF_CRM_1727715563297": {
            "fileData": [
                "test2.txt",
                "AA=="
            ]
        },
        "UF_CRM_65C0DDB2167F0": ["2187","2188"],
        "UF_CRM_1707823848879": "Խնդրի նախնական նկարագրություն",
        "UF_CRM_1709200104198": "Խնդրի փաստացի նկարագրություն",
        "UF_CRM_1727339714708" : "Հասցե",
        "UF_CRM_1707398886938": "2188",
        "UF_CRM_1722610794151": "2188",
        "UF_CRM_1710829009749": "2188",
        "UF_CRM_1722874404233" : [
            {
                "fileData": [
                    "test1.txt",
                    "AA=="
        ...
        "UF_CRM_1727427380602" : {
            "fileData": [
                "test2.txt",
                "AA=="
            ]
        },
        "UF_CRM_1707829271" : "84",
        "UF_CRM_1707829249" : "84",
        "UF_CRM_1724238491370 : 12,
        "UF_CRM_1722593134427" : "2048",
        "UF_CRM_1723818497086": "2048",
        "UF_CRM_1727343127105": "2048",
        "UF_CRM_1727430751869": "2048"
    }
}
```
...
```CATEGORY_ID```: 23- PV - մանրածախ, 26- PV - կորպորատիվ, 24- SWH - մանրածախ, 27- SWH - կորպորատիվ, 25- Service <br>
```UF_CRM_65C0DDB2167F0```: Համակարգ <br>
```UF_CRM_1707823848879```: Խնդրի նախնական նկարագրություն <br> 
```UF_CRM_1709200104198``` : Խնդրի փաստացի նկարագրություն <br>
```UF_CRM_1727339714708``` : Հասցե <br>
```UF_CRM_1707398886938```: Սպասարկման տարբերակ <br>
```UF_CRM_1722610794151```: Վճարման տեսակը (Service)
```UF_CRM_1710829009749```: Սպասարկման համար <br>
```UF_CRM_1722874404233``` : Սպասարկման ակտ (ստորագրված) <br> 
```UF_CRM_1727427419129``` : Պահեստ / Սպասարկող ակտ <br>
```UF_CRM_1727427380602``` : Պահեստ / Սպասարկող ակտ (ստորագրված) <br>
...
Գործարքի տվյալներ
```UF_CRM_1727772090639```: ԱՋՏ-ի ծավալ/լ <br>
```UF_CRM_1727772136792```: ԱՋՏ-ի քանակ <br>
...
```UF_CRM_1727715543786```: Հանձնման-ընդունման ակտ ջրատաքացուցիչներ <br>
```UF_CRM_1727715563297```: Հանձնման-ընդունման ակտ ջրատաքացուցիչներ (ստորագրված) <br>
...
```UF_CRM_1707829271``` : Սպասարկող օպերատոր <br>
```UF_CRM_1707829249``` : Սպասարկող մասնագետ <br>
```UF_CRM_1724238491370``` : Ճանապարհ/Կմ <br>
```UF_CRM_1722593134427``` : Մերժման պատճառ (Service) <br>
...
```UF_CRM_1727879297283```: Заказ клиента Подтверждено Yes <br>
...
```UF_CRM_1723818497086```: Обслуживание <br>
```UF_CRM_1727343127105```: Качества звонка <br>
...
```UF_CRM_1727430751869```: Обслуживание GUID <br>
...
```UF_CRM_1736350790973```: Установка системы GUID <br>
